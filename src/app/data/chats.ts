...
export const chats: ChatThread[] = [
  {
    ...
    messages: [
      ...
      },
      {
        id: "tom-10",
        senderId: "tom",
        timestamp: "03/03/2026 12:02 PM",
        body: "I brought soup to your office. You were in a meeting with three file boxes and zero humans.",
      },
      {
        id: "tom-11",
        senderId: "sarah",
        timestamp: "03/03/2026 12:04 PM",
        body: "The boxes were better listeners than the last committee.",
      },
      {
        id: "tom-12",
        senderId: "tom",
        timestamp: "03/03/2026 12:05 PM",
        body: "One box was leaking on a legal pad. I am not ready to rank it above Whitfield.",
      },
      {
        id: "tom-6",
        senderId: "sarah",
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: "em-12",
        senderId: "sarah",
        timestamp: "03/10/2026 08:17 PM",
        body: "It was still cake-shaped.",
      },
      {
        id: "em-13",
        senderId: "em",
        timestamp: "03/10/2026 08:18 PM",
        body: "Dad called it a symbol. I called it dry.",
      },
      {
        id: "em-14",
        senderId: "sarah",
        timestamp: "03/10/2026 08:19 PM",
        body: "I will bring something that isn't from a vending machine.",
      },
      {
        id: "em-8",
        senderId: "sarah",
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: "staff-7",
        senderId: "sarah",
        timestamp: "03/11/2026 09:11 AM",
        body: "Can someone check whether the south wall outlet is grounded? The monitor flickers when the humidifier kicks on.",
      },
      {
        id: "staff-8",
        senderId: "staff",
        timestamp: "03/11/2026 09:18 AM",
        body: "Facilities: outlet tested normal. Humidifier not found in B2.",
        kind: "system",
      },
      {
        id: "staff-9",
        senderId: "sarah",
        timestamp: "03/11/2026 09:20 AM",
        body: "Then please tell the thing humming under my desk that it is not officially present.",
      },
      {
        id: "staff-5",
        senderId: "staff",
  ...
  },
  {
    ...
    participants: [
      ...
      },
      {
        ...
        address: "david.bishop@arkham-orchards.com",
        presence: "offline",
      },
    ],
    messages: [
      {
        id: "dad-1",
        senderId: "dad",
        timestamp: "03/08/2026 06:03 PM",
        body: "Your sister says you are working too late again. I am practicing not sounding worried. It is going badly.",
      },
      {
        id: "dad-2",
        senderId: "sarah",
        timestamp: "03/08/2026 06:15 PM",
        body: "I am eating. There is a banana on my desk with my name on it.",
      },
      {
        id: "dad-3",
        senderId: "dad",
        timestamp: "03/08/2026 06:16 PM",
        body: "Writing your name on fruit is not a meal plan.",
      },
      {
        id: "dad-4",
        senderId: "sarah",
        timestamp: "03/08/2026 06:17 PM",
        body: "It is provenance.",
      },
      {
        id: "dad-5",
        senderId: "dad",
        timestamp: "03/12/2026 07:42 PM",
        body: "I found the old mug from your mother's office. The ugly green one. Em says you wanted it.",
      },
      {
        id: "dad-6",
        senderId: "sarah",
        timestamp: "03/12/2026 07:44 PM",
        body: "I did. Please do not wash it. That sounds gross but please.",
      },
      {
        id: "dad-7",
        senderId: "dad",
        timestamp: "03/12/2026 07:45 PM",
        body: "I will put it aside. I am allowed to worry about that sentence later.",
      },
    ],
  },
  {
    id: "chat-armitage",
    title: "Robert Armitage",
    contactId: "armitage",
    mode: "readonly",
    unlock: { type: "puzzleSolved", puzzleId: "lot_114" },
    evidenceId: "chat_armitage_archive",
    participants: [
      {
        id: "sarah",
        displayName: "Sarah Bishop",
      ...
      {
        id: "armitage",
        displayName: "Robert Armitage",
        address: "robert.armitage@miskatonic-research.org",
        presence: "offline",
      },
    ],
    messages: [
      {
        id: "armitage-1",
        senderId: "sarah",
        timestamp: "03/04/2026 11:06 AM",
        body: "Do you have Miriam Bishop's 1998 accession correspondence in the restricted cabinet or did Legal move it again?",
      },
      {
        id: "armitage-2",
        senderId: "armitage",
        timestamp: "03/04/2026 11:19 AM",
        body: "Legal does not move things. Legal prevents things from being findable.",
      },
      {
        id: "armitage-3",
        senderId: "armitage",
        timestamp: "03/04/2026 11:20 AM",
        body: "I will leave a folder at the desk. Read it in the building. Do not scan it.",
      },
      {
        id: "armitage-4",
        senderId: "sarah",
        timestamp: "03/04/2026 11:22 AM",
        body: "That sounds like advice from someone who expects me to scan it.",
      },
      {
        id: "armitage-5",
        senderId: "armitage",
        timestamp: "03/04/2026 11:23 AM",
        body: "It is advice from someone who remembers your mother ignoring better advice.",
      },
    ],
  },
];
