...
export const EVIDENCE_CARDS: Record<string, BoardCard> = {
  photo_sarah_office: {
    ...
    preview: "/photos/sarah_archive_office_2026.webp",
  },
  photo_miriam_sarah_1998: {
    ...
    preview: "/photos/miriam_sarah_1998.webp",
  },
  photo_sarah_em_coast: {
    ...
    preview: "/photos/sarah_em_coast_2025.webp",
  },
  photo_sarah_tom_2024: {
    ...
    preview: "/photos/sarah_tom_campus_2024.webp",
  },
  photo_bishop_birthday_2025: {
    ...
    preview: "/photos/bishop_birthday_2025.webp",
  },
  photo_sarah_em_kitchen_2025: {
    ...
    preview: "/photos/sarah_em_kitchen_2025.webp",
  },
  ...
  voicemail_to_em: {
    ...
    category: "audio",
    summary: "An ordinary answering-machine pickup, recorded weeks before the case began.",
  },
  reasons_to_stop: {
    id: "reasons_to_stop",
  ...
  office_frames_11_13: {
    ...
    preview: "/photos/office_frames_11_13.webp",
  },
  paint_doodles: {
    id: "paint_doodles",
    ...
    preview: "/photos/sarah_meeting_doodles.webp",
  },
  photo_sarah_bus_2025: {
    ...
    preview: "/photos/sarah_bus_2025.webp",
  },
  whateley_accession_card: {
    ...
    preview: "/artifacts/whateley_accession_card_1998.webp",
  },
  miriam_notebook: {
    id: "miriam_notebook",
    ...
    preview: "/artifacts/miriam_working_notebook_1998.webp",
  },
  dad_recipe: {
    id: "dad_recipe",
  ...
  lot_114_scan: {
    ...
    preview: "/artifacts/114-verso.webp",
  },
  counting_audio: {
    id: "counting_audio",
    title: "counting.wav",
  ...
  hydrographic_chart: {
    ...
    preview: "/artifacts/innsmouth_hydrographic_chart.webp",
  },
  do_not_open: {
    id: "do_not_open",
  ...
  office_after_photo: {
    ...
    preview: "/photos/office_after_2026.webp",
  },
  future_access_log: {
  ...
  tom_relay_disk_photo: {
    ...
    preview: "/artifacts/tom_relay_disk_2026.webp",
  },
  tom_upload_notes: {
    id: "tom_upload_notes",
  ...
  split_record: {
    ...
    category: "document",
    summary: "Sarah tested spreading her own name across files before leaving the relay's recipient field blank.",
  },
  directory_comparison: {
    id: "directory_comparison",
    title: "BISHOP_TREE.CMP",
    category: "record",
    summary: "Two source trees produce a directory that existed in neither source.",
  },
  observer_directory: {
    id: "observer_directory",
    title: "FIRST_SEEN.DIR",
    category: "record",
    summary: "The observer directory was created by comparing the Bishop records.",
  },
  office_1998_overlay: {
    id: "office_1998_overlay",
    title: "office_1998.jpg",
    category: "photo",
    summary: "The archive office in 1998, with a label gap that belongs to no object.",
    preview: "/photos/office_1998_overlay.webp",
  },
  office_tomorrow_overlay: {
    id: "office_tomorrow_overlay",
    title: "office_tomorrow.jpg",
    category: "photo",
    summary: "Tomorrow's office is older than today's and preserves a vertical absence.",
    preview: "/photos/office_tomorrow_overlay.webp",
  },
  three_times_alignment: {
    id: "three_times_alignment",
    title: "Three-time alignment",
    category: "record",
    summary: "No exposure contains a figure; the difference between all three preserves its outline.",
  },
  silent_call: {
    id: "silent_call",
    title: "CALL_0314.WAV",
    category: "audio",
    summary: "A call with no route hides information in the difference between two nearly identical channels.",
  },
  counter_index_note: {
    id: "counter_index_note",
    title: "DO_NOT_COMPLETE.NFO",
    category: "document",
    summary: "Sarah preserved an operation that restores a record while leaving one field incomplete.",
  },
  blank_space: {
    id: "blank_space",
  ...
  bishop_transfer_box_photo: {
    ...
    preview: "/artifacts/bishop_transfer_box_1977.webp",
  },
