...
const DEFINITIONS: readonly ActivityDefinition[] = [
  ...
  },
  {
    id: "lot-114",
    program: "casefile",
    title: { en: "How did Volume II reappear?", pt: "Como o Volume II reapareceu?" },
    summary: {
      en: "Lot 114 opened a gap in the provenance trail. The Casefile holds the records that can reconstruct its route.",
      pt: "O Lote 114 abriu uma lacuna na procedência. O Casefile reúne os registros que podem reconstruir esse percurso.",
    },
    priority: "critical",
  ...
  },
  {
    id: "deduction-ready",
    program: "casefile",
    title: { en: "A deduction is ready", pt: "Uma dedução está pronta" },
    summary: {
      en: "The facts are established. Choose a thesis and prove what they mean.",
      pt: "Os fatos estão estabelecidos. Escolha uma tese e prove o que eles significam.",
    },
    priority: "critical",
    occurred: (state) => Boolean(state.flags.first_deduction_available),
  },
  {
    ...
    summary: {
      en: "Who marked Chapter Seven before Sarah? A second surface appeared in her recovered folder.",
      pt: "Quem marcou o Capítulo Sete antes de Sarah? Uma segunda superfície apareceu na pasta recuperada dela.",
    },
    priority: "critical",
    artifactId: "cipher_1",
  ...
  },
  {
    ...
    summary: {
      en: "Whose voice is concealed beneath the counting? The recovered audio can now be examined.",
      pt: "De quem é a voz escondida sob a contagem? O áudio recuperado agora pode ser examinado.",
    },
    priority: "critical",
  ...
  },
  {
    ...
    summary: {
      en: "Why does another voice emerge from Sarah's recording? The reversed channel left a stable transcript.",
      pt: "Por que outra voz emerge da gravação de Sarah? O canal reverso deixou uma transcrição estável.",
    },
    priority: "critical",
    artifactId: "counting_audio",
  ...
  },
  {
    ...
    summary: {
      en: "Why does Sarah's record place her actions one day ahead? The displaced sequence can now be reconstructed.",
      pt: "Por que o registro de Sarah coloca suas ações um dia à frente? A sequência deslocada agora pode ser reconstruída.",
    },
    priority: "critical",
  ...
  },
  {
    ...
    summary: {
      en: "Who do Chapter Seven's four references name? INDEX.HLP describes how they join.",
      pt: "Quem é nomeado pelas quatro referências do Capítulo Sete? INDEX.HLP descreve como elas se unem.",
    },
    priority: "critical",
  ...
  },
  {
    ...
    summary: {
      en: "The four references now point to one unresolved owner. The human record is waiting for a decision.",
      pt: "As quatro referências agora apontam para um único proprietário não resolvido. O registro humano espera uma decisão.",
    },
    priority: "critical",
